...
public class Laundryku extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_transaksi = new java.awt.Button();
        btn_batal = new java.awt.Button();
        ...
        jLabel1.setText("FARHAN LAUNDRY");
        ...
        combo_jenis.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        combo_jenis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih", "Cuci Basah", "Cuci Kering", "Cuci Setrika" }));
        ...
        txt_ttlharga.setEditable(false);
        ...
        btn_transaksi.setLabel("Transaksi");
        ...
        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 5)); // NOI18N
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/10848381_2150-removebg-preview.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(combo_jenis, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(txt_harga, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_berat, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_ttlharga, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_bayar, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(227, 227, 227)
                .addComponent(btn_transaksi, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_berat, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_ttlharga, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_transaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_transaksiActionPerformed
        if (txt_ttlharga.getText().isEmpty() || txt_berat.getText().isEmpty() || txt_ttlharga.getText().isEmpty() || txt_bayar.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Data Harus Diisi");
        } else {
            float bayar = Float.parseFloat(txt_bayar.getText());
            float kembalian = bayar - Total_Harga;
            if (bayar > Total_Harga) {
                JOptionPane.showMessageDialog(null, "Kembalian Anda :\n" + (int) kembalian);
            } else {
                float kurang = kembalian * -1;
    ...
    private void txt_beratKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_beratKeyReleased
        if (txt_berat.getText().equals("")) {
            ...
            int fTotal = (int) Total_Harga;
            txt_ttlharga.setText(String.valueOf(fTotal));
        }
    ...
    private java.awt.Button btn_batal;
    private java.awt.Button btn_transaksi;
